...
if __name__ == "__main__":
    ...
    dota2darknet(
        os.path.join(filedir, "..", "dataset", "trainsplit", "images"),
        os.path.join(filedir, "..", "dataset", "trainsplit", "labelTxt"),
        os.path.join(filedir, "..", "dataset", "trainsplit", "labels"),
        util.wordname_15,
    )
    dota2darknet(
        os.path.join(filedir, "..", "dataset", "valsplit", "images"),
        os.path.join(filedir, "..", "dataset", "valsplit", "labelTxt"),
        os.path.join(filedir, "..", "dataset", "valsplit", "labels"),
        util.wordname_15,
    )
